...
public class ManyToMany {
	...
	private String relateJoinColumn;
	...
	public String getRelateJoinColumn() {
		return relateJoinColumn;
	}
	public void setRelateJoinColumn(String relateJoinColumn) {
		this.relateJoinColumn = relateJoinColumn;
	}
}
