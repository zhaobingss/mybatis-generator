...
public class ManyToManyPlugin extends PluginAdapter {
	...
	public boolean modelBaseRecordClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
		...
		for (ManyToMany otm : introspectedTable.getManyToManys()) {
	...
	public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
		...
		for (ManyToMany manyToMany : introspectedTable.getManyToManys()) {
			...
			if (tc != null) {
				...
				String columnName = manyToMany.getColumn();
				...
				sql += " FROM " + tableName + " WHERE " + manyToMany.getJoinColumn() +" IN (SELECT "+manyToMany.getRelateJoinColumn()+" FROM "+manyToMany.getRelateTable()+" WHERE "+manyToMany.getRelateColumn()+" =#{"+columnJavaProp+"})";
				if (StringUtility.stringHasValue(manyToMany.getWhere())) {
					sql += " AND " + manyToMany.getWhere();
				}
